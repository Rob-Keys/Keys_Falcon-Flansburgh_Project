...
test_pred <- predict(log_model, testing, type = "response")
prediction <- ifelse(test_pred > 0.5, 1, 0)

confusion_matrix <- table(Predicted = prediction, Actual = testing$`Athlete/Non-Athlete`)
confusion_matrix
```

# Multiple Linear Regression

This code block creates and filters the data to the necessary variables for our future multiple line regression.
