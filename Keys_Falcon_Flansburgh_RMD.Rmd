...
fit <- glm(mlrData$`MHC-SF OVERALL` ~ mlrData$`AIMS_ TOTAL`+mlrData$`I consider myself an athlete`+mlrData$`I have many goals related to sport`+mlrData$`most of my friends are athletes`+mlrData$`Sport is the most important part of my life`+mlrData$`I spend more time thinking about sport than anything else`+mlrData$`I feel bad about myself when I do badly in sport`+mlrData$`I would be very depressed if I were injured and could not compete in sport`, data = mlrData)
summary(fit)
